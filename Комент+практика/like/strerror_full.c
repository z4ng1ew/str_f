...
#define MAX_ERR_MESSAGES_INDEX 134 


#define MIN_ERR_MESSAGES_INDEX -1 
...
static const char *err_messages_arr[] = { 
...
char *s21_strerror(int error_code) { 
  ...
  if (error_code >= MAX_ERR_MESSAGES_INDEX || error_code <= MIN_ERR_MESSAGES_INDEX) { 
   ...
   sprintf(error_message_result, "%s%d", ERR_CODE_OUTSIDE, error_code);

  } else {



   strncpy(error_message_result, err_messages_arr[error_code], 299); 
  } 
