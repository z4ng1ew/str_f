...
START_TEST(strcspn_test_string_with_string) {
  ...
  ck_assert_int_eq(strcspn(str1, str1_search), s21_strcspn(str1, str1_search));
}
END_TEST
...
START_TEST(strcspn_test_string_with_empty) {
  ...
  ck_assert_int_eq(strcspn(str2, str2_search), s21_strcspn(str2, str2_search));
}
END_TEST
...
START_TEST(strcspn_test_empty_with_string) {
  ...
  ck_assert_int_eq(strcspn(str3, str3_search), s21_strcspn(str3, str3_search));
}
END_TEST
...
START_TEST(strcspn_test_string_with_signes) {
  ...
  ck_assert_int_eq(strcspn(str4, str4_search), s21_strcspn(str4, str4_search));
}
END_TEST
