...
// Функция-тест, проверяющая работу s21_strpbrk с пустой строкой в качестве первого аргумента
...
// Функция-тест, проверяющая работу s21_strpbrk с первой строкой заканчивающейся на нулевой символ
...
// Функция-тест, проверяющая работу s21_strpbrk с строкой цифр и подстрокой из них
...
TCase *test_strpbrk(void) {
    ...
    return tc; // Возвращаем TCase, который будет использоваться для добавления в Suite в другом месте
}
