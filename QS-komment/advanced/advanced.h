...
// Парсинг значений из форматной строки в структуру
...
// Трансформирование спецификаторов
...
// Преобразование ширины, точности, флагов
...
// Функция записи текста по флагам в str
